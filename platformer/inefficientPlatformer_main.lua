...
function playerMove()
	...
	playerVector = {x=playerXAccel, y=playerYAccel}
	-- playerTarget = player
	
	-- uncollideWithTerrain(playerRect, playerVector)
	
	-- playerRect.x, playerRect.y = uncollideWithTerrain(playerRect, playerVector, 0)
	playerRect = uncollideWithTerrain(playerRect, playerVector, 0)
	
	-- print(detectTerrainCollisionWith(playerRect))
